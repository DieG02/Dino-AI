...
export const zodInterface = z.object({
...
export const schema = zodTextFormat(zodInterface, "ReferralMessage");
...
export const ReferralGenerator: Omit<PromptContext, "update"> = {
